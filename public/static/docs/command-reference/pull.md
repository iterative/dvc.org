...
to increase open file descriptors limit. On UNIX systems that can be done using
 `ulimit -n`. In case of Windows, please refer to [official resources](https://blogs.technet.microsoft.com/markrussinovich/2009/09/29/pushing-the-limits-of-windows-handles/).
