...
`a304afb96060aad90176268345e10355` above is the file hash of the `data.xml` file
we just added to DVC. If you check the `data/data.xml.dvc` DVC-file, you will
see that it has this string inside.
