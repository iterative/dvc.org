...
If you use one of the supported [ML Frameworks](/dvclive/ml-frameworks), you can
...
See [`Live()`](/dvclive/live) for details.
...
[setup a pipeline]: /dvclive/how-it-works#setup-to-run-with-dvc
