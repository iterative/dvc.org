...
1. **The required columns were not imported:** Iterative Studio will only import
   ...
   **What if the repository has more than 5000 columns?** Currently Iterative
   Studio cannot import over 5000 columns. If you have a large repository (with
   more than 5000 columns), one solution is to split the
