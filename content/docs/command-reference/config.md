...
- `ui.light` - Indicates that a light theme is used in the terminal. Accepts
  values true and false (default). This option is used to properly colorize the
  table generated by `dvc exp show`.
