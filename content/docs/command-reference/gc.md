...
- `--all-commits` - same as `-a` or `-T` above, but applies to all your Git
  commits, and in the workspace (implying `-w`). This preserves the cache for
  all data used in the entire commit history of the project.
