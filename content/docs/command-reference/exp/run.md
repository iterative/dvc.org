...
- `-S [<filename>:]<param_name>=<param_value>`,
  `--set-param [<filename>:]<param_name>=<param_value>` - set the specified existing
...
comes with the `--set-param` (`-S`) option built-in, which can modify existing 
parameters within a params file. This saves you the need to manually edit the 
params file:
