...
```dvctable
$get-started-exp-show-only-changed
```
...
```dvctable
$get-started-exp-show-drop-prepare
```
...
```dvctable
$get-started-exp-show-drop-regex
```
...
```dvctable
$get-started-exp-show-sort-desc
```
...
```dvctable
$get-started-exp-show-all-commits
```
