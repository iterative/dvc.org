...
output the [Vega specification](https://vega.github.io/vega/docs/specification/)
file instead of rendering an HTML plot. For example, to generating another image
