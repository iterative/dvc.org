...
DVC is able to handle two general types of plots:

1. Data series files, which can be JSON, YAML, CSV or TSV files.
2. Image files, like JPEG, GIF, PNG.

DVC generates plots as static HTML websites that can be open with a web browser.
