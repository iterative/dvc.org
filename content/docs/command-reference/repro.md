...
> Note that stages without dependencies or outputs are considered [always changed](/doc/command-reference/stage/add#--always-changed),
> so `dvc repro` always executes them.
