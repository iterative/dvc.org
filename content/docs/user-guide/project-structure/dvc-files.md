...
| `version_id`                    | Version ID native to the cloud provider. Used to track each file in the cloud if [cloud versioning](/doc/user-guide/data-management/cloud-versioning) is enabled.                                                                                                                                                                                     |
