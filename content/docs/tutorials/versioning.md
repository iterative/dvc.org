...
Note that the contents under `.dvcgnore` file won't get affected when switching
between versions concluding that the files that are untracked in one version
will also remain untracked in other versions. See
