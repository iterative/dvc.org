...
their versions to Git. _Models_ in a machine learning project are typically
large files written and read by programs. DVC can track and version model files
similar to data files. Next questions are: How can we _use_ these artifacts
outside of the project? How do I download a model to deploy it? How do I
download a specific version of a model? How do I reuse datasets across different
projects?
