...
in DVC Studio as a model type artifact (you can also set up DVC Studio to show other artifact types, but they are hidden by default). The rest of the parameters are
