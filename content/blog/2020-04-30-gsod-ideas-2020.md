...
1. **SEO/ Site Analytics.** Our current website analytics are somewhat basic. We
   ...
   results (with meta content, media optimization, etc.), as well as to
   understand the behavior of our users to improve their experience. The
   specifics of the project are left for the applicant to suggest! This should
   be relatively simple for someone with proven experience in SEO or website QA.
