...
descriptionLong: |
  ...
  refactoring engine that takes the advantage of the AST module in the standard
  library. Through using it, we can find-and-fix patterns in massive codebases.
