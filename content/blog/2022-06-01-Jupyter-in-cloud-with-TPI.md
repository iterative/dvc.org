...
idle instances racking up our credit card bill. When terminating the instance,
the files stored there (such as notebooks) will be downloaded to the `shared`
...
hourly rate for this type of instance is $0.526. Spot instances, on the other
hand, are only $0.15 per hour. With little to no effort, TPI allows us to reduce
our cloud costs by a factor of 3.5!
