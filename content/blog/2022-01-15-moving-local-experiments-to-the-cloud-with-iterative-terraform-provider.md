...
project and trained a CNN model locally to classify different subspecies.
...
- Your training code. It is likely that you have a [whole pipeline](https://dvc.org/doc/start/data-pipelines) with multiple
...
you what my configuration file looks like, and then we'll unpack what's going on here:
...
so you may need to increase it. The image I picked expectes volume of at least 130 GB, 
and I can configure this in the `disk_size` argument.
