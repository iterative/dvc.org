...
const links = {
  [OSX]: {
    title: 'Mac OS',
    url: `https://github.com/iterative/dvc/releases/download/0.15.2/dvc-0.15.2.pkg`
  },
  [WINDOWS]: {
    title: 'Windows',
    url: `https://github.com/iterative/dvc/releases/download/0.15.2/dvc-0.15.2.exe`
  },
  [LINUX]: {
    title: 'Linux Deb',
    url: `https://github.com/iterative/dvc/releases/download/0.15.2/dvc_0.15.2_amd64.deb`
  },
  [LINUX_RPM]: {
    title: 'Linux RPM',
    url: `https://github.com/iterative/dvc/releases/download/0.15.2/dvc-0.15.2-1.x86_64.rpm`
  },
  [UNKNOWN]: {
