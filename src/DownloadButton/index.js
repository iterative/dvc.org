...
const links = {
  [OSX]: {
    title: 'Mac OS',
    url: `https://github.com/iterative/dvc/releases/download/0.14.0/dvc-0.14.0.pkg`
  },
  [WINDOWS]: {
    title: 'Windows',
    url: `https://github.com/iterative/dvc/releases/download/0.14.0/dvc-0.14.0.exe`
  },
  [LINUX]: {
    title: 'Linux Deb',
    url: `https://github.com/iterative/dvc/releases/download/0.14.0/dvc_0.14.0_amd64.deb`
  },
  [LINUX_RPM]: {
    title: 'Linux RPM',
    url: `https://github.com/iterative/dvc/releases/download/0.14.0/dvc-0.14.0-1.x86_64.rpm`
  },
  [UNKNOWN]: {
